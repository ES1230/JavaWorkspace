...
public class Music implements Comparable<Music>{
	 ...
	 * 
	 * equals메서드를 오버라이딩 한다면 항상 hashCode도 함께 오버라이딩 해줘야한다.
	 * 두 객체간에 equals결과가 true라면(같은 필드값을 가지고 있다면),hashCode로 반환된 값도 동일해야한다.
	 * 
	 */
	...
	public boolean equals(Object o) {
		...
		Music other = (Music) o;//다른자료형의 객체가 넘어 왔다면 형변환 에러가 발생하기 때문
	...
	public int compareTo(Music o) {
		//매개변수의 Music객체는 현재 객체와 비교하고자하는 객체
