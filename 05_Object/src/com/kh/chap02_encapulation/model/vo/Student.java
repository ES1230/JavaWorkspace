...
public class Student {
	 ...
	 *}
	 *setter -> setXXX
	 *해당 필드에 대입하고자 하는 값을 전달 받아 해당필드에 대입시켜주는 기능의 메소드
	 *이때 이 메소드는 접근이 가능해야하기 때문에 public 접근제한자 사용
	 *
	 */
	...
	public void setName(String name) {
		...
		//왜 ? 필드명과 매개변수명이 동일한경우{}영역 내부에서 선언한 변수가 우선순위가 높기때문에
		//생성된 객체의 name에 접근하려면 this를 사용해야함
		//this에는 생성된 객체의 "주소값"이 보관되어있다.
		this.name = name;
		
	
	}
	//나이값을 기록 및 수정할 수 있는 기능의 메서드(age필드에 값을 대입하기위한 용도)
