...
//import java.lang.*;
//생략가능, 보이진 않지만 항상 자동으로 모든 클래스에는 java.lang패키지내부의 클래스가 import되어있음

public class MathRun {
public static void main(String[] args) {
	//Math클래스 관련 기능(수학과 관련된 기능을 제공)
	
	//파이 => Math 클래스내의 상수필드 3.141592...
	System.out.println("파이 : "+Math.PI);
	
	//메소드명(매개변수) : 반환형
	//올림처리메서드 => Math.ceil(double) : double
	double num1 = 4.349;
	 ...
	 *  -모든 메서드 : static 메서드
	 *  
	 *  모든게 다 static이기 때문에 멤버에 접근시 Math.필드 or Math.메서드명 으로 다 접근가능
	 *  즉, 객체를 생성할 필요가 없다.
	 *  
