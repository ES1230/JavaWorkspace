...
public class Run {
	...
	public static void main(String[] args) {
		//Sports 객체생성 불가능
		//Sports s = new Sports();// 추상 클래스는 객체 생성이 불가능 -> 미완성된 클래스 이기 때문에
		
		//단, 객체생성은 불가능하지만, 참조변수로는 사용가능
		
		Sports s;
		s= new Football();//즉, 다형성을 적용해서 자식객체를 생성하고 이를 저장하는 용도로 사용가능
		
		Sports [] arr = new Sports[2];
		arr[0] = new Football(11);
		arr[1] = new Basketball(5);
